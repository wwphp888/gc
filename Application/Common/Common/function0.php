...
function erweima($uid,$domain){
		...
		$value = 'http://www.quandui.wang/tg.php?mid='.$uid; //二维码内容  
...
//	$domain=$GLOBALS['_CFG']['site']['tgurl'];
	...
	// 合成二维码（二维码大小282*282)
		...
		//imagecopyresized( $im_dst, $im_src,170, 530, 0, 0,160,160, 490, 490);

imagecopyresized( $im_dst, $im_src,195, 580, 0, 0,250,250, 490, 490);
