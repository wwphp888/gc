...
<body class="withvernav">
	<div class="bodywrapper">   
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
            ...
            <input type="hidden" name="id" value="<?php echo ($money['id']); ?>">
            <input type="hidden" name="money1" value="<?php echo ($money['money']); ?>">
            <input type="hidden" name="money2" value="<?php echo ($new['money']); ?>">
            <input type="hidden" name="uid" value="<?php echo ($new['id']); ?>">
				<table class="form-table" cellspacing="1" border="0">
					...
					<tr>
						<th class="title">账户可用金额</th>
						<td>
							<?php echo ($money['money']); ?>
						</td>
					</tr>
					<tr>
						<th class="title">申请提现金额</th>
						<td>
							<?php echo ($new['money']); ?>
						</td>
					</tr>
					<tr>
						<th class="title">用户支付</th>
						<td>
							<img src="<?php echo ($img['imgurl']); ?>" class="img-responsive" alt="Responsive image">
						</td>
					</tr>
