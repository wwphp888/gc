	...
	<div class="bodywrapper">   
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
            ...
            <form class="stdform stdform2" method="post">
				...
				<p>
					<label>新用户赠送</label>
					<span class="field" style="color:red"><input type="text" name="cash" id="cash" value="<?php echo ($_CFG["withdraw"]["cash"]); ?>" class="smallinput" />*必须小于最小提现金额</span>
				</p>
				<!-- <p>
					<label>推荐赠送</label>
					<span class="field" style="color:red"><input type="text" name="recommend1" id="recommend1" value="<?php echo ($_CFG["withdraw"]["recommend1"]); ?>" class="smallinput" />*1级推荐赠送</span>
				</p>
				<p>
					<label>推荐赠送</label>
					<span class="field" style="color:red"><input type="text" name="recommend2" id="recommend2" value="<?php echo ($_CFG["withdraw"]["recommend2"]); ?>" class="smallinput" />*2级推荐赠送</span>
				</p>
				<p>
					<label>推荐赠送</label>
					<span class="field" style="color:red"><input type="text" name="recommend3" id="recommend3" value="<?php echo ($_CFG["withdraw"]["recommend3"]); ?>" class="smallinput" />*3级推荐赠送</span>
				</p> -->
				<p>
					<label>默认不控制开奖金额</label>
					<span class="field" style="color:red"><input type="text" name="money" id="money" value="<?php echo ($_CFG["withdraw"]["money"]); ?>" class="smallinput" />*当期投注总金额小于此金额时随机开奖</span>
				</p>
