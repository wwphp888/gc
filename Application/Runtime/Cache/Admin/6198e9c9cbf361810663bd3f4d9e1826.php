...
<body class="withvernav">
	<div class="bodywrapper">   
        ...
        <div class="pageheader notab">
            <h1 class="pagetitle">客服设置</h1>
            <span class="pagedesc">米粒小屋提示www.m213.cn上传客服的微信二维码</span>
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">    
            ...
            <form class="stdform stdform2" method="post">
				...
				<table cellpadding="0" cellspacing="0" border="0" id="table2" class="stdtable stdtablecb">
                    ...
                    <tbody>
						<?php if(is_array($_CFG['cs']['config'])): $i = 0; $__LIST__ = $_CFG['cs']['config'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td>
