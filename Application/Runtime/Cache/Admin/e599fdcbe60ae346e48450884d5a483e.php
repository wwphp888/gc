...
<body class="withvernav">
	<div class="bodywrapper">   
        ...
        <div class="pageheader notab">
            ...
            <h1 class="pagetitle">代理设置</h1>


            <span class="pagedesc">设置代理的账户信息</span>
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
            ...
            <form action='<?php echo U("setAgentAccount",["user_id"=>$user_id,"agent_id"=>$agent_info["id"]]);?>' class="stdform stdform2" method="post">
				...
				<p>
					...
					<span class="field"><input type="text" value="<?php echo ($agent_info["username"]); ?>" name="agent_name" id="agent_name"  class="smallinput" /></span>
				...
				<p>
					...
					<span class="field"><input type="password" name="agent_password" id="url"  class="smallinput" /></span>
				...
				<p class="stdformbutton">
					...
					<input type="reset" class="reset radius2" value="重置" />
                        ...
                        <input type="hidden" name="agent_id" value='<?php echo ($agent_info["id"]); ?>'>
			</form>
