	...
	<div class="bodywrapper">   
			...
			<ul>        	
				<li>				
					...
					<ul id="formsub">               		
						...
						<!--<li><a href="<?php echo U('Config/banner');?>">充值设置</a></li>-->
        ...
        <div id="contentwrapper" class="contentwrapper lineheight21">
            ...
            <form class="stdform stdform2" method="post">
				<p>
					<label>1级推荐</label>
					<span class="field" style="color:red"><input type="text" name="parent1" id="recommend1" value="<?php echo ($list["parent1"]); ?>" class="smallinput" />*按%比赠送，填数字即可，例：填8，即佣金为8%。默认8即可</span>
				</p>
				<p>
					<label>2级推荐</label>
					<span class="field" style="color:red"><input type="text" name="parent2" id="recommend2" value="<?php echo ($list["parent2"]); ?>" class="smallinput" />*按%比赠送，填数字即可，例：填8，即佣金为8%。默认5即可</span>
				</p>
				<p>
					<label>3级推荐</label>
					<span class="field" style="color:red"><input type="text" name="parent3" id="recommend3" value="<?php echo ($list["parent3"]); ?>" class="smallinput" />*按%比赠送，填数字即可，例：填8，即佣金为8%。默认2即可</span>
				</p>
