                ...
                <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                        <div class="flex-cont flex-simple">
                            <div class="flex-item s-word">
                                <p class="s-tit">常见问题 <?php echo ($vo["id"]); ?>：<?php echo ($vo["question"]); ?></p>
                                <div class="panel">
                                <p class="s-desc">回答：<?php echo ($vo["answer"]); ?></p>
                                </div>
                                <p class="s-desc"><?php echo date('Y-m-d H:i',$vo['time']);?></p>
                            </div>                            
                        </div>
...
<?php if(empty($list)): ?><div style=" padding:10px 0; color:#666;text-align: center;">暂时没有问题</div><?php endif; ?>
<html lang="en">
