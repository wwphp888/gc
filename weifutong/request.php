...
Class Request{
	...
	{
        $this->reqHandler->setReqParams($info ,array('method'));
		...
		$this->reqHandler->setParameter('notify_url','http://'.$_SERVER['HTTP_HOST'].'/weifutong/callback.php');//
		$this->reqHandler->setParameter('callback_url','http://'.$_SERVER['HTTP_HOST'] );
        $this->reqHandler->setParameter('is_raw','0');
        ...
        if($this->pay->call()){
            ...
            if($this->resHandler->isTenpaySign()){
                ...
                if($this->resHandler->getParameter('status') == 0 && $this->resHandler->getParameter('result_code') == 0){
                    return json_encode(array('pay_info'=>$this->resHandler->getParameter('pay_info'),
                        'is_raw'=>$this->reqHandler->getParameter('is_raw'),
