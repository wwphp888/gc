<?php
/*
修改时间：2018-10-06 18:04
使用方法：  
$order_count =$this->db->table($order_table_name)->getField('COUNT(`skl_id`)');// 查询满足要求的总数
require_once(SKL_ClASS_PATH.'ShoukuanlaPage.class.php');
$order_page = new ShoukuanlaPage($order_count,10);// 实例化分页类 传入总数和每页显示的条数
echo $order_page->show();//输出分页
*/

class ShoukuanlaPage {
     ...
     */
    public function __construct($totalRows=null,$listRows=null) {
