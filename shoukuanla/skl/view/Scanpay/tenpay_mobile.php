...
<title>QQ钱包付款操作流程</title>
<meta name="keywords" content="QQ钱包付款操作流程"/>
<meta name="description" content="QQ钱包付款操作流程"/>
...
.copy{
	background-image: url(<?php echo SKL_STATIC_PATH; ?>images/tencopy.jpg);
...
.inputsty{ font-size: 18px; width: 220px; height: 28px; }
...
<p>
<b>第一步：手指长按二维码不放再点击识别二维码，或者把二维码截图保存后登录手机QQ扫码</b>
</p>
...
<div>
<span>
<p><b>第一步：登录您的手机QQ钱包进入转账页面</b></p>
<p><b>第二步：将下边的收款账号金额备注信息复制到QQ钱包转账页面，然后点击确定转账</b></p>
<p>
<table width="100%">
  <tr>
...
<div class="copy">
<form name="form">
 <div class="inputEmail"> <input style="text-align: center;" onClick="this.select();" name="Email" class="inputsty" name="input" type="text" value="<?php echo $post['email']; ?>" > </div>

 <div class="inputEmail" style="padding-top:58px;"> <input onClick="this.select();" style="height: 40px;font-size: 30px;" class="inputsty" name="money" type="text" value="<?php echo $post['is_float'] == '1'? $post['short_order']: $post['money']; ?>" > </div>
 
 <div class="inputEmail" style="padding-top:10px;padding-left: 18px;"> <input onClick="this.select();" style="height: 30px;width: 260px;" class="inputsty" name="text" type="text" value="<?php if($post['is_float'] != '1'){ echo $post['short_order']; }?>" > </div>
</div>
</p>
