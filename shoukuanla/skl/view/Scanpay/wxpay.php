...
.inputsty{ font-size: 16px; width: 230px; height: 28px; }
    ...
    .alipay-logo {
        ...
        background-repeat: no-repeat;
        background-image: url(<?php echo SKL_STATIC_PATH; ?>images/wxlogo.png);
    }
</style>
...
<div class="qrguide-area" id="J_qrguideArea" seed="NewQr_animationClick">
    <img id="qrguideimg" src="<?php echo SKL_STATIC_PATH; ?>images/wxalert.png" class="qrguide-area-img active">
