...
<style>
.copy{
	background-image: url(<?php echo SKL_STATIC_PATH; ?>images/copy.jpg);
...
.inputsty{ font-size: 16px; width: 230px; height: 28px; }
    ...
    .alipay-logo {
        ...
        background-repeat: no-repeat;
        background-image: url(<?php echo SKL_STATIC_PATH; ?>images/t1hhfgxxvexxxxxxxx.png);
    }
</style>
...
<div class="qrguide-area" id="J_qrguideArea" seed="NewQr_animationClick">
    <img id="qrguideimg" src="<?php echo SKL_STATIC_PATH; ?>images/t13cpgxf8mxxxxxxxx.png" class="qrguide-area-img active">
...
<div <?php if(!$is_remittance){ echo 'style="display:none;"'; } ?> class="view-switch qrcode-show fn-left" id="J_viewSwitcher" unselectable="on" onselectstart="return false;" seed="NewQr_viewSwitch">
    ...
    <div class="switch-tip switch-qrcode-tip " id="J_tip_qr">
        ...
        <div class="switch-tip-icon-wrapper">
            ...
            <img class="switch-tip-icon-img" src="<?php echo SKL_STATIC_PATH; ?>images/t1hhfgxxvexxxxxxxx.png" alt="支付宝图标" width="50" height="17">
        </div>
    ...
    <div class="switch-tip switch-pc-tip fn-hide" id="J_tip_pc">
        ...
        <div class="switch-tip-icon-wrapper">
            ...
            <img class="switch-tip-icon-img" src="<?php echo SKL_STATIC_PATH; ?>images/t1z5xfxdxmxxxxxxxx.png" alt="手机支付宝图标" width="30" height="30">
        </div>
...
<div class="copy">
 ...
 <div class="inputEmail" style="padding-top:45px;"> <input onClick="select()" style="width: 100px;" class="inputsty" name="money" type="text" value="<?php if($post['is_float'] == '1'){ echo $post['short_order']; }else{ echo $post['money']; } ?>" readonly> </div>
 
 <div class="inputEmail" style="padding-top:48px;"> <input onClick="select()" style="width: 230px;" class="inputsty" name="text" type="text" value="<?php if($post['is_float'] != '1'){ echo $post['short_order']; } ?>" readonly> </div>
</div>
            </div>
            ...
            <div class="submitContainer fn-clear">
                <div class="left-submitContainer fn-left" style="margin-left: 163px;">
                    <a rel="noreferrer" href="https://shenghuo.alipay.com/send/payment/fill.htm?title=<?php echo $post['short_order']; ?>" target="_blank" class="newBtn-blue newBtn-long" style="width: 230px;">
                        <span>去支付宝付款</span>
                    </a>
                </div>
            </div>
