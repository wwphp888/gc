...
.moneyBox li{ font-size: 13px; float: left; height: 18px; width: 21%; margin-left: 5px; margin-right: 5px; border: 1px double #C4DEFF; border-radius: 5px; text-align: center; margin-bottom: 15px; cursor: pointer; color: #333; padding: 10px; }
.selectli{
...
.payBox li{ font-size: 18px; float: left; height: 40%; width: auto; margin-left: 5px; margin-right: 5px; border: 1px double #C4DEFF; border-radius: 5px; text-align: center; padding-top: 6px; padding-right: 6px; padding-left: 6px; margin-bottom: 10px; cursor: pointer; color: #333; padding-bottom: 2px; }
.gediv{
...
<form action="<?php echo $skl_action_url; ?>" method="post">
...
<input money-type="1" style="width:80%;height:80%;color: #666;font-size:10px;" name="skl_custom_money" type="text" value="其他金额" />
</li>';
...
echo '<h2 style="font-size:16px; float:left;">请选择支付方式</h2>
<div id="id_pay_box" class="payBox">';

foreach($paytype_start as $v){
		
  echo '<li id="'.$v.'"><img src="'.SKL_STATIC_PATH.'images/'.$v.'.png" height="20px" /></li>';	
...
<div class="payBox" style="border-bottom-style: none;">
<input type="text" name="<?php echo $alias_obj->post_alias['username']; ?>" value="<?php echo $poUsername; ?>" style="width:95%;height:30px;margin-left: 5px;" />
</div>
